<template>
  <section class="space-y-6">
    <header class="rounded-3xl border border-white/10 bg-white/5 p-8">
      <p class="text-sm font-medium uppercase tracking-[0.3em] text-amber-300/80">
        Agent Detail
      </p>
      ...
      <p class="mt-4 max-w-2xl text-sm leading-7 text-stone-300">
        Placeholder view for agent configuration, rubric generation status, and performance summaries.
      </p>
    </header>
  </section>
</template>
